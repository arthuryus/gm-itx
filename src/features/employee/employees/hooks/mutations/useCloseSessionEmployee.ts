...
import type { TCloseSessionRequest, TCloseSessionResponse } from '../../api/employees-api.types.ts'

export function useCloseSessionEmployee() {
    const queryClient = useQueryClient()

    return useMutation<TCloseSessionResponse, Error, TCloseSessionRequest>({
