...
import type { TGroup, TGroupFilter } from '@/features/customer/groups/model/group.types.ts'
...
import { useDeleteGroup } from '@/features/customer/groups/hooks/mutations/useDeleteGroup.ts'
import { PERMISSIONS } from '@/shared/config/permissions.ts'
import { useAccess } from '@/features/access/hooks/use-access.ts'
import { GroupsTable } from '@/features/customer/groups/ui/GroupsTable.tsx'
...
export default function GroupsPage() {
    ...
    const canCreate = useAccess({ permission: PERMISSIONS.PERMISSION_CUSTOMER_GROUPS_CREATE }, true)
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                {canCreate && (
                    <Button asChild>
                        <Link to={PAGE_URLS.customerGroups.create()}>
