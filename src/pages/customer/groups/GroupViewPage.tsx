...
export default function GroupViewPage() {
    ...
    const canEdit = useAccess({ permission: PERMISSIONS.PERMISSION_CUSTOMER_GROUPS_EDIT }, false)
    const canDelete = useAccess({ permission: PERMISSIONS.PERMISSION_CUSTOMER_GROUPS_DELETE }, false)
