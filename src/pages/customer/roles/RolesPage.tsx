...
import type { TRole, TRoleFilter } from '@/features/customer/roles/model/role.types.ts'
import { DEFAULT_PER_PAGE } from '@/shared/constants/main.ts'
import { PAGE_URLS } from '@/shared/config/page-routes.ts'
import { useGetRoles } from '@/features/customer/roles/hooks/queries/useGetRoles.ts'
import { useDeleteRole } from '@/features/customer/roles/hooks/mutations/useDeleteRole.ts'
import { PERMISSIONS } from '@/shared/config/permissions.ts'
import { useAccess } from '@/features/access/hooks/use-access.ts'
import { RolesTable } from '@/features/customer/roles/ui/RolesTable.tsx'
